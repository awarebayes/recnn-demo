...
# this is needed for streamlit/click
...
RUN pip install pandas sklearn matplotlib scipy tqdm jupyterthemes streamlit==0.51.0
RUN conda install faiss-cpu -c pytorch
RUN pip install git+git://github.com/awarebayes/RecNN.git
